...
<>↦-↓closed : ∀ {𝑥 𝑦 𝑧} → ⊑ᵥ [ 𝐴 × 𝐵 ] 𝑦 𝑧 →
              <>↦ 𝑡 𝑢 𝑥 𝑧 → <>↦ 𝑡 𝑢 𝑥 𝑦
<>↦-↓closed {𝑦 = ⟪ < y₁ , y₂ > ,, ⟪⟫ ⟫}
  (⊑ᵥ-cons _ () ⊑ᵥ-nil) <>↦-intro₁
<>↦-↓closed {𝑦 = ⟪ ⊥ₓ ,, ⟪⟫ ⟫}
  (⊑ᵥ-cons _ _ ⊑ᵥ-nil) <>↦-intro₁
  = <>↦-intro₁
<>↦-↓closed {𝑦 = ⟪ ⊥ₓ ,, ⟪⟫ ⟫}
  (⊑ᵥ-cons _ _ ⊑ᵥ-nil) (<>↦-intro₂ _ _)
  = <>↦-intro₁
<>↦-↓closed {𝑥 = 𝑥} {⟪ < y₁ , y₂ > ,, ⟪⟫ ⟫}
  (⊑ᵥ-cons _ (⊑ₓ-intro₂ y₁⊑z₁ y₂⊑z₂) ⊑ᵥ-nil)
  (<>↦-intro₂ 𝑡𝑥↦y₁ 𝑢𝑥↦y₂)
  = <>↦-intro₂ t𝑡𝑥↦y₁ t𝑢𝑥↦y₂
  where ty₁⊑z₁ = ⊑ᵥ-cons [ 𝐴 ] y₁⊑z₁ ⊑ᵥ-nil
        t𝑡𝑥↦y₁ = Appmap.↦-↓closed 𝑡 ty₁⊑z₁ 𝑡𝑥↦y₁
        ty₂⊑z₂ = ⊑ᵥ-cons [ 𝐵 ] y₂⊑z₂ ⊑ᵥ-nil
...
<>↦-con <>↦-intro₁ (<>↦-intro₂ _ _) _
  = con-tup conₓ-⊥₂ con-nil
<>↦-con (<>↦-intro₂ _ _) <>↦-intro₁ _
  = con-tup conₓ-⊥₁ con-nil
