...
ap↦-mono 𝑥⊑𝑦 (ap↦-intro₂ x y 𝑓 𝑡𝑥↦𝑓 𝑢𝑥↦x xy⊑𝑓)
  = ap↦-intro₂ x y 𝑓 𝑡𝑦↦𝑓 𝑢𝑦↦x xy⊑𝑓
...
ap↦-↓closed {𝑦 = ⟪ λᵤ 𝑓 , ⟪⟫ ⟫} (⊑ᵥ-cons _ _ _ 𝑓⊑y ⊑ᵥ-nil)
  (ap↦-intro₂ x′ y′ 𝑓′ 𝑡𝑥↦𝑓′ 𝑢𝑥↦x′ x′y′⊑𝑓′)
  = ap↦-intro₂ x′ (λᵤ 𝑓) 𝑓′ 𝑡𝑥↦𝑓′ 𝑢𝑥↦x′ x′𝑓⊑𝑓′
